...
This is the initial `0.0.1` planning version of the Claude Code Skill.
...
This Claude Code Skill must remain behaviorally equivalent to the Codex/OpenAI Skill at `.agents/skills/autonomous-dev-loop/SKILL.md`.

For now, treat this file as the Claude Code Skill entry point placeholder only.
